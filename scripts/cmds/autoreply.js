module.exports = {  
  ...
  onChat: async function ({ event, api }) {  
    ...
    // ✅ EXACT MATCH
    const exactReplies = [
      { words: ["love you bot","love u bot","bot love you","bot love u"], reply: "বস মালয়েশিয়া সিঙ্গেল বয় মেয়েদে'র সাথে কথা বলতে মানা করছে-🙂🤗🐸" },
      { words: ["bot jamay dau","বট জামাই দাও"], reply: "আমার বস ফারহান কে চোখে দেখো না নাকি__😒🥱" },
      { words: ["i love you bot","bot i love you"], reply: "আমাকে না আমার বস মালয়েশিয়া সিঙ্গেল বয় কে ভালোবাসো-😻🤗🌺" },
      ...
      { words: ["single","hriday"], reply: "আমি সিঙ্গেল আছি প্রেম করলে নক দে বলদ!😾" },
      ...
      { words: ["বট চুপ","bot tham","স্টপ","stop","চুপ","chup thak"], reply: "-না আমি চুপ থাকবো না-😼-বস মালয়েশিয়া সিঙ্গেল বয় আমারে কথা বলতে বলছে-🥱🥷" },
      { words: ["চুম্মাহ দাও","kiss me"], reply: "️-আমি দিবো না-😏-বস মালয়েশিয়া সিঙ্গেল বয় কে বলো চু'মু দিতে-🫣🐸" },
      { words: ["bot ar bacca","বট এর বাচ্ছা","bot er bacca"], reply: "উফফ-🥵-ঝাং-🤤-আমার বস মালয়েশিয়া সিঙ্গেল বয় এর বাচ্ছা তো তোমার পেটে-🥱💦" },
      ...
      { words: ["তোর বানাইছে কে","এটা কার বট","tor banayse ke","ata kar bot"], reply: "️আমার বস মালয়েশিয়া সিঙ্গেল বয় আমাকে শুধুমাত্র আপনাদের কে বিনোদনের জন্য তৈরি করেছেন__😊😌" },
      { words: ["miss you"], reply: "<আমি তোমাকে রাইতে মিস খাই🥹🤖👅/👅-✘ মালয়েশিয়া সিঙ্গেল বয় 🎀 🍒:))" },
      ...
      { words: ["/owner"], reply: "OWNER: MR. BOSS মালয়েশিয়া সিঙ্গেল বয়" },
      { words: ["admin ke","tor boss ke"], reply: "❤️ হাই আমি মেছেন্জার ROBOT  আামার বস মালয়েশিয়া সিঙ্গেল বয় আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন" },
      { words: ["admin","boter admin"], reply: "HE IS মালয়েশিয়া সিঙ্গেল বয় ❤️" },
